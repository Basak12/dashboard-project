...
const TabsForHomework = () => {
    ...
    const rows = [
        createData('Öğrenci 1', 940, 78, <CheckIcon color = 'success'/>, <Typography color = 'success'> 60%</Typography>),
        createData('Öğrenci 2', 237, 66, <CloseIcon color = 'error'/>, <Typography color= 'error'> 20%</Typography>),
        createData('Öğrenci 3', 262, 82, <CheckIcon color = 'success'/>,  <Typography color= 'error'> 30%</Typography>),
        createData('Öğrenci 4', 305, 75, <CloseIcon color = 'error'/>,  <Typography color= 'success'> 75%</Typography>),
        createData('Öğrenci 5', 356, 80, <CheckIcon color = 'success'/>,  <Typography color= 'success' > 80%</Typography>),
    ];
    const items = [
        {
            id: 1,
